...
public class Stagiaire extends JFrame {
	...
	int IDstagiaire;
	String nom,prenom,datenaissance,sexe,adresse,ville,cp,pays,mail, rechercheS;
	...
	public Stagiaire() {
		...
		modif.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new TraitementStagiaire().modifStagiaire(IDstagiaire, nom, prenom, datenaissance, sexe, adresse, ville, cp, pays, mail);
