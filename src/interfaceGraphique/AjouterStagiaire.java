...
public class AjouterStagiaire extends JFrame {
	...
	JPanel pan;
	JLabel nom, prenom, datenaissance, sexe, adresse, cp, ville, pays, mail;
	JTextField TFnom, TFprenom, TFdatenaissance, TFadresse, TFcp, TFville, TFpays, TFmail;
	JComboBox<String> CBsexe;
	JButton retour, ajout;
	// on créer des variables qui vont stocker les données entrées par la suite
	String nomS="", prenomS="",datenaissanceS="",sexeS="",adresseS="",cpS="",villeS="",paysS="",mailS="",pseudo="",mdp="";
	...
	public AjouterStagiaire() {
		...
		ajout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				// on stock toutes les variables dans les ...S pour les utilisés dans ajoutStagiaire.
